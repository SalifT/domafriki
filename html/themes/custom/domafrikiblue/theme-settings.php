 ...
 */
function domafrikiblue_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  // If the default theme is either domafrikiblue or socialsaas then extend
  ...
  if (array_key_exists('socialbase', \Drupal::service('theme.manager')->getActiveTheme()->getBaseThemes())) {
    if ($active_theme == $system_theme_settings) {
      ...
      $form['#submit'][] = 'domafrikiblue_save_email_logo';
 ...
 */
function domafrikiblue_save_email_logo(array $form, FormStateInterface $form_state) {
